...
// let alien1 = new Alien('durgesh', 'js')
// let alien2 = new Alien('kumar', 'blockchain')
...
// //array forech method 
// let nums12 =[42,67,51,98,12,24];
// nums12.forEach((n,i,nums12)=>{
//     console.log(n,i,nums12)
// });

//Array method filter map reduce 
let nums13 =[42,67,51,98,12,24];
nums13.forEach((n)=>{
    console.log(n)
});
//take parameter and take arugumeter and check condition
let result = nums13.filter(n=>n%2===0)
//map take value and change value
.map(n=>n*2) 
